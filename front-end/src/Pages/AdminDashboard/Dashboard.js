...
import BookingSearchBar from '../../Components/BookingSearch';
...
export default function Dashboard(props) {
    ...
    return (
      ...
      <Typography variant="h5" color="#DB4437" paragraph className={classes.welcometext}>
        ...
        {(showBookings && onBehalfOfUserEmail !== undefined)&&  <Typography variant="body1" color="textSecondary" align='center'> <MyBookings bookings={bookings} onBehalfOfUserEmail={onBehalfOfUserEmail} isAdmin={true} token={props.token}/></Typography>}
              </Paper>
        </Container>
