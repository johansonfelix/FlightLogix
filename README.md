...
<div align="center" style="display: flex; flex-direction: column; justify-content:space-around">
 <img style="flex: 1" src="DOCUMENTATION/usecasediagram.png" width="25%"/>
  <img  style="flex: 1" src="DOCUMENTATION/UML.png" width="50%"/>
 </div>
